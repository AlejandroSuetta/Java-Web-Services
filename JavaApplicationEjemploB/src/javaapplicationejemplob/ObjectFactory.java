 ...
 * generated in the javaapplicationejemplob package. 
...
public class ObjectFactory {
    ...
    private final static QName _SumarResponse_QNAME = new QName("http://ws.java.curso.edu/", "sumarResponse");
    private final static QName _Sumar_QNAME = new QName("http://ws.java.curso.edu/", "sumar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: javaapplicationejemplob
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.java.curso.edu/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.java.curso.edu/", name = "sumar")
